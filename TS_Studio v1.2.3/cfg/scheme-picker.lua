...
1. Pick a color scheme by clicking on its name:
  ...
  - [TouchSprite Studio](macro:inline(ide.config.styles = StylesGetDefault(); local c = ide.config; c.stylesoutshell = c.styles; c.styles.auxwindow = {}; ReApplySpecAndStyles()))
